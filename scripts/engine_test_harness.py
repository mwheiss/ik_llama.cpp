...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--numa", choices=["distribute", "isolate", "numactl", "mirror"], default=None, help="Baseline --numa strategy.")
    ap.add_argument("--ik-numa", choices=["distribute", "isolate", "numactl", "mirror"], default=None, help="Optimized/test --numa strategy. Defaults to --numa.")
